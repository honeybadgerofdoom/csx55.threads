...
public class Registry implements Node {
    ...
    private void printFinalOutput() {
        ...
        System.out.println(String.format("| %-17s | %17s | %17s | %17s | %17s | %17s |", "Node", "Generated", "Pulled", "Pushed", "Completed", "% of Tasks"));
        System.out.println(tableLine);
        ...
        System.out.println(tableLine);
        System.out.println(String.format("| %-17s | %17d | %17d | %17d | %17d | %17f |", "TOTAL", totalGenerated, totalPulled, totalPushed, totalCompleted, totalPercent));
        System.out.println(tableLine);
    }
